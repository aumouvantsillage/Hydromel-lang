...
(define inst (fifo2b-make #f 0))

(port-set! (inst c valid) (signal 0  1  1  1  1  0))
(port-set! (inst c data)  (signal 10 10 20 30))
(port-set! (inst p ready) (signal 0  0  0  0  0  0 1 0 1 0 1 0))
